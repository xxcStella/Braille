...
def main():
  ...
  # Data directory
  data_dir_name = '/Events_Examples/Experiment_Data'
  home_dir = 'F:/Files/PhD/Braille/Code/' # TODO: you will need to change this to the location of the Event_Example folder on your computer
  ...
  # Load data
  # filename = data_dir + '/taps_pin_separation_pose_0_tap_0.pickle'
  filename = data_dir + '/taps_trial_49_pose_214_events_on'
